...
$title = 'Admin Ajout Leçon | PedaCode';
...
<section class="flex flex-col min-h-screen">
    <main class="flex-1 flex flex-col gap-6 my-6">
        <h1 class="text-center text-primary-light-dm">Créer un cours</h1>
        ...
        <form action="<?= APP_ROOT ?>/adminAddLesson?categoryId=<?= $_GET['categoryId'] ?>&chapitreId=<?= $_GET['chapitreId'] ?>&lessonId=<?= $_POST['lessonId']??0 ?>" method="post" class="flex flex-col justify-around items-center bg-primary-light-dm">
            <div class="flex flex-wrap text-white gap-4 justify-around my-6 ">
                ...
                <div class="selection-lecon">
                    <!-- <label for="idLecon" class="text-nightsky-dark-dm">ID Lecon :</label> -->
                    <!-- <input type="number" id="idLecon"> -->
                    <label for="lecon" class="text-nightsky-dark-dm">Nom Leçon :</label>
                    <input type="text" name="lecon" id="lecon" class="text-nightsky-dark-dm" required>
                </div>
            ...
            <div class="flex flex-wrap text-white gap-4 justify-around w-full">
                <div class="w-full">
                    <div class=" w-full flex flex-col items-center justify-center">
                        ...
                        <textarea name="instruction" id="instruction" rows="10" class="text-nightsky-dark-dm w-[90%]" required></textarea>
                    </div>
                    <div class="w-full flex flex-col items-center justify-center">
                        <label for="objectif" class="text-nightsky-dark-dm">Objectif :</label>
                        <textarea name="objectif" id="objectif" rows="10" class="text-nightsky-dark-dm w-[90%]" required></textarea>
                    </div>
            ...
            <div class="button my-6">
                <button type="submit" class="bg-nightsky-dark-dm m-auto p-2 rounded text-white hover:bg-nightsky-light-dm ">Soumettre</button>
            </div>
        </form>
    </main>
</section>
